            ...
            <div className="container">
                ...
                <div className="max-w-lg mx-auto">
                    <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">
                        Building a Creative & Innovative Engineering Experience
                    </h1>
                    <p className="mt-4 text-center text-white/90 md:text-lg">
                        Experienced in software development, embedded systems and system design
                        with a focus on building real-time, data-driven technologies.
                        Skilled in Python, C/C++, while bringing in a blend of technical precision and cross-functional
                        teamwork to every project, with a focus on delivering robust, scalable solutions in embedded development.
                    </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
                    ...
                    <a
                        href="https://personal-site-three-olive.vercel.app/contact"
                        target="_blank"
                    ...
                    >
                        <span>⚽️ 🥺</span>
                        <span className="font-semibold animate-bounce [animation-duration:1.5s]">
                            Let's Connect!
                        </span>
                    </a>
                </div>
